...
const DEFAULT_CAPABILITIES: AutonomyCapability[] = [
  ...
  { name: "Creative rotation", detail: "Detects a creative worn out against its own peak — significance-tested, never on a wobble — and recommends what to vary. Replacing is still yours to press.", level: 1, max: 3 },
