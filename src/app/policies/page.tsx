...
const POLICIES: { name: string; href: string; blurb: string; live?: boolean }[] = [
  ...
  { name: "Creator Earnings & Payouts", href: "/terms", blurb: "0.5% with no follower gate, 0.75% and 1% on verified counts. A commission is earned rather than granted: a brand may dispute it on stated grounds but cannot quietly withhold it. Paid gross — nothing is withheld for tax, because a creator is not an employee." },
  { name: "Withdrawal Fees & Reporting", href: "/terms", blurb: "The payout provider's processing fee at cost, plus 3% of that fee as administration — never 3% of your withdrawal. Every charge itemised before you confirm, and annual earnings reported to the tax authority with a copy to you." },
