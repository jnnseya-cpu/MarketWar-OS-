...
const SUITES: Suite[] = [
  ...
  { icon: Filter, title: "AI Funnel Builder", status: "live", note: "Copy, structure and the hosted page are live — pages publish to /b/<brand>/<slug>. The checkout is NOT on the page yet: the engine that validates your own payment link is written and tested, but there is no field to enter one and no button rendered, so do not plan a launch around it. When it lands, money will go straight to your account and never through MarketWar.", desc: "Landing pages, lead magnets, sales/webinar/appointment/course/e-commerce funnels, abandoned-cart flows, checkout optimisation, upsell journeys." },
