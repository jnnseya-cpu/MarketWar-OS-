...
(`scripts/smoke.mjs` — all 34 page routes, security headers, all 30 agents
end-to-end, audit + gateway + reputation/search/intent/warfare/image/acu/geo/
email/amplify APIs; 92 checks). Global error boundary + not-found surfaces
ship in `src/app/`.
