...
(`scripts/smoke.mjs` — all 33 page routes, security headers, all 29 agents
end-to-end, audit + gateway + search/intent/warfare/image/acu/geo/email/amplify
APIs; 87 checks). Global error boundary + not-found surfaces ship in `src/app/`.
