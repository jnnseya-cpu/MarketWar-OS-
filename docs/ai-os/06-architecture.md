...
(`scripts/smoke.mjs` — all 35 page routes, security headers, all 32 agents
end-to-end, audit + gateway + roi/reputation/search/intent/warfare/image/acu/
geo/email/amplify APIs; 97 checks). Global error boundary + not-found surfaces
ship in `src/app/`.
