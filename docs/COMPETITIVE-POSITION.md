...
| Documented engines (each with its own API + zero-config demo) | **47** | `ENGINE_REGISTRY` |
...
The engines by category: Economics & Governance (10), Market Intelligence (9),
Engagement & Retention (6), Content & Reporting (6), Acquisition & Campaigns (5),
...
7. **Breadth is not depth.** 47 engines and 39 agents is a wide surface. In any
