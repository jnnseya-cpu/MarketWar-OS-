...
The engines by category: Economics & Governance (10), Market Intelligence (8),
Engagement & Retention (6), Acquisition & Campaigns (5), Content & Reporting (5),
Local & Marketplace (3), Video Intelligence (1).
...
7. **Breadth is not depth.** 38 engines and 39 agents is a wide surface. In any
