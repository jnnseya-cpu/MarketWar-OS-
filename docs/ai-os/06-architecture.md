...
(`scripts/smoke.mjs` — all 32 page routes, security headers, all 27 agents
end-to-end, audit + gateway + intent/warfare/image/acu/geo/email/amplify APIs;
81 checks). Global error boundary + not-found surfaces ship in `src/app/`.
