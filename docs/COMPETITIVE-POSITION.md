...
| Documented engines (each with its own API + zero-config demo) | **50** | `ENGINE_REGISTRY` |
...
The engines by category: Economics & Governance (12), Market Intelligence (9),
...
7. **Breadth is not depth.** 50 engines and 39 agents is a wide surface. In any
