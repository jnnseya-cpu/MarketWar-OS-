...
(`scripts/smoke.mjs` — all 36 page routes, security headers, all 33 agents
end-to-end, audit + gateway + segments/roi/reputation/search/intent/warfare/
image/acu/geo/email/amplify APIs; 100 checks). Global error boundary +
