...
const STUDIO: Studio[] = [
  ...
  { icon: MonitorPlay, title: "Screen & Presentation Recorder", status: "live", note: "Live now — record your whole screen with yourself on it, drag your picture anywhere mid-take, and download it. No key needed.", desc: "Screen, camera and voice in one file — turn demos into training modules, social clips and help-centre videos." },
